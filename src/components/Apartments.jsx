...
function Apartments() {
  return (
    <div className="w-[100%] flex-col justify-start items-center gap-20 flex">
        ...
        <div className="px-32 py-5 bg-[#7FDBCA] hover:cursor-pointer rounded-full border justify-center items-center gap-2.5 inline-flex">
            <div className="text-white text-base font-bold font-['Acumin Pro'] leading-normal">View More</div>
        </div>
    </div>
  )
}
