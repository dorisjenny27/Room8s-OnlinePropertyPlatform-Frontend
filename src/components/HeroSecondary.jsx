    ...
    <div className='p-10'>
        <div className="md:flex justify-between items-center gap-10">
            ...
            <div className='basis-1/2 flex-col'>
                ...
                <div className=" mb-1hover:cursor-pointer px-32 py-3.5 bg-[#7FDBCA]  rounded-full border justify-center items-center gap-2.5 inline-flex">
                    <div className="text-white text-base font-bold font-['Acumin Pro'] leading-normal">Search </div>
                </div>
            </div>
